...
<header>
<blockquote>
	<img src="image/bookstorelogo.png">
	<input class="hi" style="float: right; margin: 2%;" type="button" name="cancel" value="Home" onClick="window.location='main.php';" />
</blockquote>
</header>
<?php
session_start();
...
if(isset($_SESSION['id'])){
	...
	echo '<blockquote>';
?>
<input class="button" style="float: right;" type="button" name="cancel" value="Continue Shopping" onClick="window.location='main.php';" />
<?php
