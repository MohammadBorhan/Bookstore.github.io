...
if(isset($_SESSION['id'])){
	echo '<header>';
	echo '<blockquote>';
	echo '<a href="main.php"><img src="image/bookstorelogo.png"></a>';
...
echo '<blockquote>';
    ...
    while($row = $result->fetch_assoc()) {
	    echo "<td>";
	    echo "<table>";
	   	echo '<tr><td>'.'<img src="'.$row["Image"].'"width="80%">'.'</td></tr><tr><td style="padding: 5px;">Title: '.$row["BookTitle"].'</td></tr><tr><td style="padding: 5px;">Author: '.$row["Author"].'</td></tr><tr><td style="padding: 5px;">Type: '.$row["Type"].'</td></tr><tr><td style="padding: 5px;">$'.$row["Price"].'</td></tr><tr><td style="padding: 5px;">
	...
	<form style='float:right;' action='' method='post'><input type='hidden' name='delc'/>
	<input class='cbtn' type='submit' value='Empty Cart'></form></th>";
    $total = 0;
	?>
